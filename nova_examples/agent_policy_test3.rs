    ...
    G::Scalar: PrimeField + PrimeFieldBits,
{
    ...
    fn synthesize<CS: ConstraintSystem<G::Scalar>>(
        ...
        //
        // Private witness:
        // constraint of +_amount spent in one step
        ...
        // budget_next < 512
        //
        let bits = budget_next.to_bits_le(
            cs.namespace(|| "budget_next_bits")
        )?;
...
fn main() {
    println!("Nova Budget Trace Example");
    println!("========================================");
